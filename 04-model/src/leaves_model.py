"""
Mask R-CNN
Train on the Leaves dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 leaves_model.py train --dataset=/path/to/leaves_model/dataset --weights=imagenet

    # Apply color splash to an image
    python3 leaves_model.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>

    # Apply color splash to video using the last weights you trained
    python3 leaves_model.py splash --weights=last --video=<URL or path to file>
"""
...
def train(model):
    ...
    dataset_train.load_leaves(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = LeavesDataset()
    dataset_val.load_leaves(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train Mask R-CNN to detect leaves.")
    parser.add_argument("command", metavar="<command>", help="'train' or 'splash'")
    parser.add_argument(
        "--dataset",
        required=False,
        metavar="/path/to/leaves/dataset/",
        help="Directory of the Leaves dataset",
    )
    parser.add_argument(
        "--weights",
        required=True,
    ...
    if args.command == "train":
        ...
        class InferenceConfig(LeavesConfig):
